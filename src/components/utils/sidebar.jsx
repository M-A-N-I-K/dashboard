...
const sidebar = () => {
    return (
        <nav
            className="z-50 fixed bottom-[10vh] sm:top-0 sm:absolute w-[100vw] h-[7vh] sm:h-[100vh] flex-row sm:flex-col items-end justify-between flex-shrink-0 sm:w-16 sm:py-4 bg-gray-100 sm:bg-white border-r-2 border-indigo-100 shadow-md flex rounded-3xl sm:rounded-[0px] rounded-tl-3xl rounded-bl-3xl"
        >
            <div className="flex sm:w-full sm:flex-col items-center space-y-3 flex-shrink-0 py-2 sm:py-4">
